...
router.get("/dashboard", requireAuth, requireAdmin, async (req, res) => {
  try {
    const [totalUsers, totalJobs, activeJobs, totalApplications, totalCompanies, hrUsers, candidateUsers] =
      await Promise.all([
        User.countDocuments(),
        Job.countDocuments(),
    ...
    res.json({
      stats: { totalUsers, totalJobs, activeJobs, totalApplications, totalCompanies, hrUsers, candidateUsers },
      recentUsers,
      recentJobs,
    });
  } catch (err) {
