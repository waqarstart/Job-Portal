 ...
 */
export async function generateCvInterviewQuestions(args) {
  return limit(() => generateCvInterviewQuestionsInner(args));
}

async function generateCvInterviewQuestionsInner({
  jobTitle,
  jobDescription,
  jobSkills = [],
  hrQuestions = [],
