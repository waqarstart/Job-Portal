...
// Cap concurrent OpenRouter calls from this service so a burst of
// applicants doesn't fire hundreds of simultaneous AI requests at once.
...
export async function evaluateCvAgainstJob(args) {
  return limit(() => evaluateCvAgainstJobInner(args));
}

async function evaluateCvAgainstJobInner({
  cvText,
  jobDescription,
  jobTitle,
}) {
