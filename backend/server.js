...
// crossOriginResourcePolicy is relaxed to "cross-origin" so the frontend
// (a different origin) can still load images/files from /uploads.
app.use(
  helmet({
...
// Private documents (CVs/resumes) go through an auth + ownership check
// first; anything that isn't in a private subfolder falls through to the
// plain static handler below (company logos, profile pictures — meant to
