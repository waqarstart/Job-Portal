...
import { getCachedHRNotifications, setCachedHRNotifications } from "../utils/profileCache";
...
export default function HRLayout({ children, title, subtitle, headerExtra }) {
  ...
  const [notifications, setNotifications] = useState(getCachedHRNotifications() || []);
  ...
  useEffect(() => {
    getHRApplicants()
      .then((apps) => {
        ...
        setCachedHRNotifications(recent);
      })
      .catch(() => {});
  }, []);
