...
import AdminViewCandidate from "../pages/admin/AdminViewCandidate";
...
import HRViewCandidate from "../pages/hr/HRViewCandidate";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/hr/applicants/:id/profile" element={<HRRoute><HRViewCandidate /></HRRoute>} />
