...
export default function ResumeCV() {
  ...
  async function handleDownload(cv) {
    setOpenMenuId(null);
    const url = withAuthToken(`${FILE_BASE}${cv.url}`);
            ...
            {canUpload && (
              <div className="mt-5 grid gap-4 sm:grid-cols-[1fr_1fr_auto] sm:items-end">
                ...
                <button
                  ...
                  className="transition-all duration-200 rounded-xl bg-blue-600 px-6 py-2.5 font-semibold text-white hover:bg-blue-700 disabled:opacity-60 whitespace-nowrap"
                >
                  ...
                  {visibleCvs.map((cv) => (
                    <tr key={cv._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-5 py-4 text-center">
                        <div className="relative flex items-center justify-center gap-1.5" data-actions-menu>
                          <a
                            href={withAuthToken(`${FILE_BASE}${cv.url}`)}
                            target="_blank"
                            rel="noreferrer"
                            title="View"
                          ...
                          {openMenuId === cv._id && (
                              <div className="absolute right-0 top-full mt-1 w-44 rounded-xl border border-gray-100 bg-white shadow-xl z-20 py-1 text-left">
                                <button
                                  ...
                                  className="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 transition-[background-color,padding-left] duration-200 ease hover:bg-blue-50 hover:pl-5 hover:text-blue-600"
                                >
                                ...
                                <button
                                  ...
                                  disabled={cv.locked}
                                  className="flex w-full items-center gap-2 px-4 py-2 text-sm text-red-600 transition-[background-color,padding-left] duration-200 ease hover:bg-red-50 hover:pl-5 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:pl-4"
                                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setEditCv(null)} className="transition-all duration-200 text-gray-400 hover:text-gray-600">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="transition-all duration-200 flex-1 rounded-lg border py-2.5 font-medium text-gray-600 hover:bg-gray-50"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={editSaving}
                  className="transition-all duration-200 flex-1 rounded-lg bg-blue-600 py-2.5 font-semibold text-white hover:bg-blue-700 disabled:opacity-60"
                >
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                ...
                disabled={deleting}
                className="transition-all duration-200 flex-1 rounded-lg bg-red-600 py-2.5 text-sm font-semibold text-white hover:bg-red-700 disabled:opacity-60"
              >
