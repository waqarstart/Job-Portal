...
function ChangeEmailForm({ onDone }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button onClick={handleSubmit} disabled={loading} className="transition-all duration-200 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 disabled:opacity-60">
...
function DeactivateForm({ logout }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <button onClick={handle} disabled={loading} className="transition-all duration-200 rounded-lg border border-amber-500 px-4 py-2 text-sm font-semibold text-amber-600 hover:bg-amber-50 disabled:opacity-60">
...
function DeleteForm({ logout }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button onClick={handle} disabled={loading} className="transition-all duration-200 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 disabled:opacity-60">
