          ...
          <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
                          ...
                          return (
                            <div
                              ...
                              onClick={() => {
                                ...
                                setPreviewUrl(url);
                                setF("cvFile", null); // clear uploaded file if any
                              }}
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className={`flex h-8 w-8 items-center justify-center rounded-lg ${isSelected ? "bg-blue-100" : "bg-gray-100"}`}>
                                  <HiOutlineDocumentText className={`h-4 w-4 ${isSelected ? "text-blue-600" : "text-gray-500"}`} />
                                </div>
                                <div>
                                  ...
                                  <p className="text-[10px] text-gray-400">
                                    {new Date(cv.createdAt).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}
                                  </p>
                                </div>
                              </div>
                              {isSelected && (
                                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-blue-600">
                                  <HiOutlineCheckCircle className="h-3.5 w-3.5 text-white" />
                                </div>
                              )}
                            </div>
                          );
              ...
              {applyStep === 5 && (
                <div className="py-6 text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Thank you for applying. We will review your application and get back to you soon.</p>
                  </div>
                  <div className="rounded-xl border border-gray-100 bg-gray-50 p-4 text-left space-y-2">
                    ...
                    {["Our team will review your application", "If shortlisted, we will contact you", "You can track your application in My Applications"].map((t, i) => (
                  ...
                  <button
                    onClick={() => { setShowApply(false); navigate(`/interview/${id}`, { state: { job } }); }}
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-blue-600 py-3 text-sm font-bold text-white hover:bg-blue-700 transition">
                    <HiOutlineVideoCamera className="h-5 w-5" />
                    Start AI Interview
                  </button>
                  <button onClick={() => { setShowApply(false); navigate("/my-applications"); }}
            ...
            {applyStep < 5 && (
              <div className="flex items-center justify-between border-t border-gray-100 px-6 py-4 bg-gray-50/40">
                <button type="button" onClick={applyStep === 1 ? () => setShowApply(false) : prevStep}
