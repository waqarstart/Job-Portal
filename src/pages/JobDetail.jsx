          ...
          <div className="absolute right-0 z-20 mt-1 w-48 rounded-xl border border-gray-100 bg-white py-1 shadow-xl">
            {options.map((opt) => (
              <button
                ...
                className={`flex w-full items-center gap-3 px-4 py-2.5 text-sm font-medium transition-[background-color,padding-left] duration-200 ease hover:pl-5 ${opt.color} ${opt.bg}`}
              >
                {opt.icon}
      ...
      {open && (
          <div className="absolute left-0 right-0 z-20 mt-1 rounded-xl border border-gray-100 bg-white py-1 shadow-xl overflow-hidden">
            <button
              ...
              className={`flex w-full items-center gap-2 px-4 py-2.5 text-sm transition-[background-color,padding-left] duration-200 ease hover:bg-blue-50 hover:pl-5 hover:text-blue-600 ${
                !selectedId
            ...
            {cvs.map((cv) => (
              <button
                ...
                className={`flex w-full items-center gap-2.5 px-4 py-2.5 text-sm transition-[background-color,padding-left] duration-200 ease hover:bg-blue-50 hover:pl-5 hover:text-blue-600 ${
                  selectedId === cv._id
...
export default function JobDetail() {
  ...
  async function handleSubmit() {
    try {
      ...
      setApplied(true);
      setApplyStep(5);
      showToast("Application is submitted.");
    } catch (err) {
      console.error(
        ...
        <div className="rounded-2xl border border-gray-100 bg-white shadow-sm p-6 mb-5">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5">
            ...
            <div className="flex flex-col gap-2 sm:min-w-[170px]">
              <div className="flex items-center gap-2">
                <button
                  onClick={!isLoggedIn ? () => navigate("/login") : handleApply}
                  disabled={isLoggedIn && (applied || isHrOrAdmin)}
                    ...
                    <div>
                      ...
                      <CvDropdown
                        ...
                        onSelect={(cv) => {
                          ...
                          setPreviewUrl(
                            withAuthToken(`${FILE_BASE}${cv.url}`)
                          );
                        }}
                        onClear={() => {
                          setSelectedCvId(null);
                          ...
                          <div className="mt-3 rounded-xl border border-blue-100 bg-blue-50/40 overflow-hidden">
                            ...
                            <div className="flex items-center justify-between px-4 py-2 border-b border-blue-100">
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-xs text-blue-600 transition-colors duration-200 hover:underline"
                              >
                                Open in new tab
                              </a>
                            </div>
                      ...
                      <div className="rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <div className="flex items-center justify-between px-4 py-2.5 bg-gray-50 border-b border-gray-100">
                          ...
                          <button
                            ...
                            className="transition-all duration-200 text-xs text-gray-400 hover:text-gray-600"
                          >
                            Hide
                          </button>
                        </div>
                          ...
                          (s) => (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="transition-all duration-200 ml-0.5 hover:text-red-500"
                              >
