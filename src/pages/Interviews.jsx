...
export default function Interviews() {
  ...
  // Close the per-row "..." actions menu on outside click via a passive
  // listener instead of a full-screen overlay, so the rest of the page
  ...
  return (
    ...
    >
                  ...
                  <div className="flex items-start gap-2 shrink-0 lg:flex-col lg:items-end">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="relative" data-actions-menu>
                        <button
                          ...
                          className="transition-all duration-200 p-1.5 text-gray-400 rounded-lg hover:bg-gray-100"
                        >
                    ...
                    {!isCompleted &&
                      ...
                      rating > 50 && (
                        <button
                          ...
                          className="transition-all duration-200 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-700 whitespace-nowrap disabled:cursor-not-allowed disabled:opacity-60"
                        >
                    ...
                    {isCompleted && (
                      <button
                        ...
                        className="transition-all duration-200 rounded-xl border px-5 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 whitespace-nowrap"
                      >
                        {expandedId === app._id
                          ? "Hide Feedback"
                          : "View Feedback"}
      ...
      <div className="flex flex-col gap-4 p-5 mt-6 border rounded-2xl bg-blue-50/60 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="transition-all duration-200 flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 shrink-0">
          View Resources
        </button>
      </div>
    </CandidateLayout>
