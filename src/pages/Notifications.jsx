                  ...
                  <div className="absolute right-0 top-full z-20 mt-1 w-32 rounded-lg border border-gray-100 bg-white py-1 shadow-lg">
                    {["latest", "oldest"].map((o) => (
                      <button
                        ...
                        className={`block w-full px-3 py-1.5 text-left text-sm capitalize transition-[background-color,padding-left] duration-200 ease hover:bg-blue-50 hover:pl-4 hover:text-blue-600 ${sortOrder === o ? "text-blue-600 font-medium" : "text-gray-600"}`}
                      >
                        {o}
                      </button>
                    ))}
