              ...
              {jobs.map((job) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="transition-all duration-200 rounded-lg bg-red-50 px-3 py-1.5 text-sm font-medium text-red-600 hover:bg-red-100"
                  >
                    Delete
                  </button>
                </div>
                ...
                {typeof app.interviewRating !==
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-2 border-t pt-4">
                    ...
                    <button
                      ...
                      className="transition-all duration-200 rounded-lg bg-gray-800 px-3 py-1 text-sm font-medium text-white hover:bg-gray-900 disabled:opacity-60"
                    >
