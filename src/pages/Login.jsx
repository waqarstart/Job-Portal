    ...
    >
      <div className="w-full max-w-md rounded-2xl border bg-white/95 backdrop-blur-sm p-8 shadow-xl">
        <Link to="/" className="flex flex-col items-center gap-1 mb-6">
          <img src="/images/tekky-icon.png" alt="Tekky Job" className="h-10 w-10 object-contain" />
          <span className="text-base font-semibold text-gray-800">Tekky Job</span>
        </Link>

        <h1 className="text-2xl font-bold text-gray-900 text-center">Welcome to Tekky Job</h1>
          <p className="mt-1 text-gray-500 text-center">Login to your account</p>
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 transition-colors duration-200 hover:text-gray-600"
                >
          ...
          <div className="flex justify-center gap-3">
            <GoogleSignInButton className="flex h-11 w-11 items-center justify-center rounded-xl border transition-all duration-200 hover:border-blue-300 hover:bg-gray-50 hover:shadow-md hover:scale-105" />

            <button
              type="button"
              onClick={() => setComingSoon("LinkedIn sign-in is coming soon.")}
              className="flex h-11 w-11 items-center justify-center rounded-xl border transition-all duration-200 hover:border-blue-300 hover:bg-gray-50 hover:shadow-md hover:scale-105"
