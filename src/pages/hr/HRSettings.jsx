    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <button onClick={saveProfile} disabled={savingProfile}
          className="transition-all duration-200 mt-3 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 disabled:opacity-60">
  ...
  return (
    <div className="space-y-3">
      ...
      <button onClick={handle} disabled={loading}
        className="transition-all duration-200 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 disabled:opacity-60">
...
function DeactivateForm({ logout }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button onClick={handle} disabled={loading}
        className="transition-all duration-200 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 disabled:opacity-60">
  ...
  return (
    <div className="space-y-3">
      ...
      <button onClick={handle} disabled={loading || confirmText !== "DELETE"}
        className="transition-all duration-200 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 disabled:opacity-40">
