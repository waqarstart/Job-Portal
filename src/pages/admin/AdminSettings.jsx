    ...
    <AdminLayout title="Admin Settings">
      ...
      <div className="mt-10 flex items-center justify-between border-t pt-5">
        ...
        <div className="flex items-center gap-4 text-xs text-gray-400">
          <button className="transition-all duration-200 hover:text-gray-600">Privacy Policy</button>
          <button className="transition-all duration-200 hover:text-gray-600">Terms of Service</button>
          <button className="transition-all duration-200 hover:text-gray-600">Help Center</button>
        </div>
      </div>
    </AdminLayout>
  );
