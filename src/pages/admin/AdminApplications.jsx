...
import {
  HiOutlineMagnifyingGlass, HiChevronLeft,
    ...
    <AdminLayout title="Applications">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <Dropdown
          ...
          options={[{ value: "", label: "All Jobs" }, ...jobTitles.map((t) => ({ value: t, label: t }))]}
        />
        ...
        <Dropdown
          ...
          options={[{ value: "", label: "All Status" }, ...Object.entries(STATUS_LABEL).map(([val, label]) => ({ value: val, label }))]}
        />
                  ...
                  <div className="relative">
                    ...
                    {menuOpen === app._id && (
                      <div className="absolute right-0 top-9 z-20 w-36 rounded-xl border bg-white shadow-lg py-1">
                        <button className="w-full px-4 py-2 text-left text-xs text-gray-700 transition-[background-color,padding-left] duration-200 ease hover:bg-blue-50 hover:pl-5 hover:text-blue-600">View Details</button>
                        <button className="w-full px-4 py-2 text-left text-xs text-red-500 transition-[background-color,padding-left] duration-200 ease hover:bg-red-50 hover:pl-5">Remove</button>
                      </div>
                    )}
                  </div>
                </td>
