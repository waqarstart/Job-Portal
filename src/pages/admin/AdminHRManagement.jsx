    ...
    <AdminLayout title="HR Management">
            ...
            {hrUsers.slice(0, 3).map((u) => (
              <div key={u._id} className="flex items-center justify-between py-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="transition-all duration-200 text-gray-400 hover:text-gray-600">
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Filter icon */}
          <button className="transition-all duration-200 flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 text-gray-500 hover:bg-gray-50">
                    ...
                    <div className="relative">
                      ...
                      {menu === c._id && (
                        <div className="absolute right-0 top-9 z-20 w-44 rounded-xl border bg-white shadow-lg py-1">
                          <button className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-xs text-gray-700 transition-[background-color,padding-left] duration-200 ease hover:bg-blue-50 hover:pl-5 hover:text-blue-600">
                          ...
                          <button className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-xs text-red-500 transition-[background-color,padding-left] duration-200 ease hover:bg-red-50 hover:pl-5">
        ...
        <div className="overflow-hidden rounded-2xl border bg-white shadow-sm">
          ...
          {!loading && filtered.length > 0 && (
            <div className="flex items-center justify-between border-t px-6 py-4">
              ...
              <div className="flex items-center gap-1">
                <button onClick={() => setPage((p) => Math.max(1, p - 1))} disabled={page === 1}
                  className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 text-gray-500 disabled:opacity-40 transition-all duration-200 hover:bg-gray-50 hover:border-gray-300">
                  <HiChevronLeft className="h-4 w-4" />
                </button>
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
                  <button key={p} onClick={() => setPage(p)}
