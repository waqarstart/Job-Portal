...
import {
  ...
  HiOutlineCalendarDays, HiChevronDown,
      ...
      <div className="mb-6 flex justify-end">
        <div className="relative">
          <select
            ...
            className="appearance-none rounded-xl border border-gray-200 bg-white py-2 pl-9 pr-8 text-sm text-gray-700 outline-none focus:border-blue-500 cursor-pointer"
          >
          ...
          <HiChevronDown className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
          <span className="pointer-events-none absolute left-8 top-1/2 -translate-y-1/2 text-sm text-gray-600 hidden" />
        </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="relative">
            <select
              value={range}
              onChange={(e) => setRange(Number(e.target.value))}
              className="appearance-none rounded-xl border border-gray-200 bg-white py-2 pl-3 pr-8 text-sm text-gray-700 outline-none focus:border-blue-500 cursor-pointer"
            >
              <option value={7}>Last 7 Days</option>
              <option value={14}>Last 14 Days</option>
              <option value={30}>Last 30 Days</option>
