        ...
        <div className="mt-3">
          <div className="flex items-center gap-2">
            <button
              ...
              className="transition-all duration-200 inline-flex items-center gap-1 rounded-lg border border-gray-200 px-2.5 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50"
            >
              {openTranscript ? (
      ...
      {interviewHistory?.length > 0 && (
        <div className="mt-4 border-t border-gray-100 pt-3">
          <button
            ...
            className="transition-all duration-200 inline-flex items-center gap-1 text-xs font-semibold text-gray-500 hover:text-gray-700"
          >
            {showHistory ? (
              <HiOutlineChevronUp className="h-3.5 w-3.5" />
            ) : (
