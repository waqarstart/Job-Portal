...
function supportsAV1() {
	...
	let hasAV1 = false;
	if (capabilities) {
		for (const codec of capabilities.codecs) if (codec.mimeType === "video/AV1") {
			hasAV1 = true;
			break;
		}
	}
...
function supportsVP9() {
	...
	let hasVP9 = false;
	if (capabilities) {
		for (const codec of capabilities.codecs) if (codec.mimeType === "video/VP9") {
			hasVP9 = true;
			break;
		}
	}
...
var Future = class {
	...
	constructor(futureBase, onFinally) {
		...
		this.promise = new Promise((resolve, reject) => __awaiter$1(this, void 0, void 0, function* () {
...
function detectSilence(track_1) {
	return __awaiter$1(this, arguments, void 0, function(track) {
...
function getNewAudioContext() {
	...
	if (AudioContext) {
		...
		if (audioContext.state === "suspended" && typeof window !== "undefined" && ((_a = window.document) === null || _a === void 0 ? void 0 : _a.body)) {
			const handleResume = () => __awaiter$1(this, void 0, void 0, function* () {
				var _a;
				try {
...
var E2EEManager = class extends eventsExports.EventEmitter {
		...
		this.onWorkerMessage = (ev) => {
			...
			switch (kind) {
				...
				case "enable":
					...
					break;
				case "ratchetKey": this.keyProvider.emit(KeyProviderEvent.KeyRatcheted, data.ratchetResult, data.participantIdentity, data.keyIndex);
			}
		};
	...
	*/
	...
	setupEventListeners(room, keyProvider) {
		...
		room.localParticipant.on(ParticipantEvent.LocalSenderCreated, (sender, track) => __awaiter$1(this, void 0, void 0, function* () {
...
var DeviceManager = class DeviceManager {
	...
	getDevices(kind_1) {
		return __awaiter$1(this, arguments, void 0, function(kind) {
			var _this = this;
...
var SignalClient = class {
	...
	connect(url, token, opts, abortSignal) {
		...
		const rtcUrl = createRtcUrl(url, createConnectionParams(token, getClientInfo(), opts));
		const validateUrl = createValidateUrl(rtcUrl);
		return new Promise((resolve, reject) => __awaiter$1(this, void 0, void 0, function* () {
			const unlock = yield this.connectionLock.lock();
			try {
				const abortHandler = () => __awaiter$1(this, void 0, void 0, function* () {
					this.close();
				...
				if (abortSignal === null || abortSignal === void 0 ? void 0 : abortSignal.aborted) abortHandler();
				...
				this.ws.onerror = (ev) => __awaiter$1(this, void 0, void 0, function* () {
					if (this.state !== SignalConnectionState.CONNECTED) {
						this.state = SignalConnectionState.DISCONNECTED;
						clearTimeout(wsTimeout);
						try {
							const resp = yield fetch(validateUrl);
							if (resp.status.toFixed(0).startsWith("4")) reject(new ConnectionError(yield resp.text(), ConnectionErrorReason.NotAllowed, resp.status));
							else reject(new ConnectionError("Encountered unknown websocket error during connection: ".concat(ev.toString()), ConnectionErrorReason.InternalError, resp.status));
						} catch (e) {
				...
				this.ws.onmessage = (ev) => __awaiter$1(this, void 0, void 0, function* () {
					var _a, _b, _c;
					let resp;
					if (typeof ev.data === "string") {
						const json = JSON.parse(ev.data);
						resp = SignalResponse.fromJson(json, { ignoreUnknownFields: true });
					} else if (ev.data instanceof ArrayBuffer) resp = SignalResponse.fromBinary(new Uint8Array(ev.data));
					else {
					...
					if (this.state !== SignalConnectionState.CONNECTED) {
						...
						if (((_a = resp.message) === null || _a === void 0 ? void 0 : _a.case) === "join") {
							...
							abortSignal === null || abortSignal === void 0 || abortSignal.removeEventListener("abort", abortHandler);
							this.startPingInterval();
							if (((_b = resp.message) === null || _b === void 0 ? void 0 : _b.case) === "reconnect") resolve(resp.message.value);
							else {
								this.log.debug("declaring signal reconnected without reconnect response received", this.logContext);
								resolve(void 0);
								shouldProcessMessage = true;
							}
						} else if (this.isEstablishingConnection && resp.message.case === "leave") reject(new ConnectionError("Received leave request while trying to (re)connect", ConnectionErrorReason.LeaveRequest, void 0, resp.message.value.reason));
						else if (!opts.reconnect) reject(new ConnectionError("did not receive join response, got ".concat((_c = resp.message) === null || _c === void 0 ? void 0 : _c.case, " instead"), ConnectionErrorReason.InternalError));
				...
				this.ws.onclose = (ev) => {
					if (this.isEstablishingConnection) reject(new ConnectionError("Websocket got closed during a (re)connection attempt", ConnectionErrorReason.InternalError));
	...
	sendUpdateLocalMetadata(metadata_1, name_1) {
		return __awaiter$1(this, arguments, void 0, function(metadata, name) {
			var _this2 = this;
	...
	sendRequest(message_1) {
		return __awaiter$1(this, arguments, void 0, function(message) {
			var _this3 = this;
			...
			return function* () {
				if (!fromQueue && !canPassThroughQueue(message) && _this3.state === SignalConnectionState.RECONNECTING) {
					_this3.queuedRequests.push(() => __awaiter$1(_this3, void 0, void 0, function* () {
				...
				try {
					if (_this3.useJSON) _this3.ws.send(req.toJsonString());
					else _this3.ws.send(req.toBinary());
				} catch (e) {
	...
	handleSignalResponse(res) {
		...
		if (msg.case === "answer") {
			...
			if (this.onAnswer) this.onAnswer(sd, msg.value.id);
		} else if (msg.case === "offer") {
			const sd = fromProtoSessionDescription(msg.value);
			if (this.onOffer) this.onOffer(sd, msg.value.id);
	...
	handleWSError(ev) {
		this.log.error("websocket error", Object.assign(Object.assign({}, this.logContext), { error: ev }));
	}
	/**
...
var PCTransport = class extends eventsExports.EventEmitter {
	...
	constructor(config) {
		...
		this.remoteNackMids = [];
		this.negotiate = r$1((onError) => __awaiter$1(this, void 0, void 0, function* () {
		...
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			try {
				...
				sdpParsed.media.forEach((media) => {
					...
					if (media.type === "audio") ensureAudioNackAndStereo(media, [], []);
						...
						if (trackbr.codec !== "av1") return true;
...
function ensureAudioNackAndStereo(media, stereoMids, nackMids) {
	...
	if (opusPayload > 0) {
		...
		if (stereoMids.includes(mid)) media.fmtp.some((fmtp) => {
...
var PCTransportManager = class {
	...
	constructor(rtcConfig, subscriberPrimary, loggerOptions) {
		...
		this.updateState = () => {
			...
			if (previousState !== this.state) {
				...
				(_a = this.onStateChange) === null || _a === void 0 || _a.call(this, this.state, this.publisher.getConnectionState(), this.subscriber.getConnectionState());
			}
		};
	...
	addIceCandidate(candidate, target) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			else yield this.subscriber.addIceCandidate(candidate);
		});
	}
	createSubscriberAnswerFromOffer(sd, offerId) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			try {
				if (!(yield this.subscriber.setRemoteDescription(sd, offerId))) return;
	...
	*/
	...
	get requiredTransports() {
		...
		if (this.isSubscriberConnectionRequired) transports.push(this.subscriber);
		return transports;
	}
	ensureTransportConnected(pcTransport_1, abortController_1) {
		return __awaiter$1(this, arguments, void 0, function(pcTransport, abortController) {
			var _this = this;
			...
			return function* () {
				...
				return new Promise((resolve, reject) => __awaiter$1(_this, void 0, void 0, function* () {
					const abortHandler = () => {
	...
	constructor(track, options) {
		...
		this.byteStream = new ReadableStream({
			start: (controller) => {
				...
				dataListener = (event) => __awaiter$1(this, void 0, void 0, function* () {
					let data;
...
var LocalTrack = class extends Track {
	...
	*/
	constructor(mediaTrack, kind, constraints) {
		...
		this.debouncedTrackMuteHandler = r$1(() => __awaiter$1(this, void 0, void 0, function* () {
			yield this.pauseUpstream();
		}), 5e3);
		this.handleTrackUnmuteEvent = () => __awaiter$1(this, void 0, void 0, function* () {
		...
		this.trackChangeLock.lock().then((unlock) => __awaiter$1(this, void 0, void 0, function* () {
			try {
	...
	*/
	setProcessor(processor_1) {
		return __awaiter$1(this, arguments, void 0, function(processor) {
			var _this3 = this;
...
var LocalAudioTrack = class extends LocalTrack {
	...
	*/
	constructor(mediaTrack, constraints) {
		...
		this.monitorSender = () => __awaiter$1(this, void 0, void 0, function* () {
			if (!this.sender) {
				this._currentBitrate = 0;
				return;
			}
	...
	*/
	...
	checkForSilence() {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			if (trackIsSilent) {
				if (!this.isMuted) this.log.warn("silence detected on local audio track", this.logContext);
...
var RTCEngine = class extends eventsExports.EventEmitter {
	...
	constructor(options) {
		...
		*/
		...
		this.handleDataChannel = (_a) => __awaiter$1(this, [_a], void 0, function(_ref) {
			var _this = this;
			let { channel } = _ref;
			return function* () {
				if (!channel) return;
		...
		this.handleDataMessage = (message) => __awaiter$1(this, void 0, void 0, function* () {
			var _a, _b;
			...
			try {
				...
				if (((_a = dp.value) === null || _a === void 0 ? void 0 : _a.case) === "speaker") this.emit(EngineEvent.ActiveSpeakersUpdate, dp.value.value.speakers);
					...
					if (((_b = dp.value) === null || _b === void 0 ? void 0 : _b.case) === "user") applyUserDataCompat(dp, dp.value.value);
		...
		this.isBufferStatusLow = (kind) => {
			...
			if (dc) {
				if (kind === DataPacket_Kind.RELIABLE) this.reliableMessageBuffer.alignBufferedAmount(dc.bufferedAmount);
	...
	join(url, token, opts, abortSignal) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			try {
				...
				if (!this.subscriberPrimary || joinResponse.fastPublish) this.negotiate();
	...
	*/
	...
	configure(joinResponse) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			this.pcManager.onStateChange = (connectionState, publisherState, subscriberState) => __awaiter$1(this, void 0, void 0, function* () {
	...
	setupSignalClientCallbacks() {
		this.client.onAnswer = (sd, offerId) => __awaiter$1(this, void 0, void 0, function* () {
			if (!this.pcManager) return;
			this.log.debug("received server answer", Object.assign(Object.assign({}, this.logContext), { RTCSdpType: sd.type }));
		...
		this.client.onOffer = (sd, offerId) => __awaiter$1(this, void 0, void 0, function* () {
	...
	*/
	ensureDataTransportConnected(kind_1) {
		return __awaiter$1(this, arguments, void 0, function(kind) {
			...
			return function* () {
				...
				if (needNegotiation) _this2.negotiate();
	...
	registerOnLineListener() {
		if (isWeb()) window.addEventListener("online", this.handleBrowserOnLine);
	}
	deregisterOnLineListener() {
		if (isWeb()) window.removeEventListener("online", this.handleBrowserOnLine);
	}
};
...
var RegionUrlProvider = class {
	...
	getNextBestRegionUrl(abortSignal) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			if (!this.regionSettings || Date.now() - this.lastUpdateAt > this.settingsCacheTime) this.regionSettings = yield this.fetchRegionSettings(abortSignal);
...
var ByteStreamReader = class extends BaseStreamReader {
	...
	[Symbol.asyncIterator]() {
		...
		return {
			next: () => __awaiter$1(this, void 0, void 0, function* () {
				var _a, _b;
				try {
...
var IncomingDataStreamManager = class {
	...
	handleDataStreamPacket(packet) {
		return __awaiter$1(this, void 0, void 0, function* () {
			switch (packet.value.case) {
				case "streamHeader": return this.handleStreamHeader(packet.value.value, packet.participantIdentity);
				case "streamChunk": return this.handleStreamChunk(packet.value.value);
				case "streamTrailer": return this.handleStreamTrailer(packet.value.value);
	...
	handleStreamChunk(chunk) {
		...
		if (fileBuffer) {
			if (chunk.content.length > 0) fileBuffer.controller.enqueue(chunk);
		}
		const textBuffer = this.textStreamControllers.get(chunk.streamId);
		if (textBuffer) {
			if (chunk.content.length > 0) textBuffer.controller.enqueue(chunk);
		}
	}
...
var OutgoingDataStreamManager = class {
	...
	sendText(text, options) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			handleProgress(1, 0);
			yield writer.close();
			if ((options === null || options === void 0 ? void 0 : options.attachments) && fileIds) yield Promise.all(options.attachments.map((file, idx) => __awaiter$1(this, void 0, void 0, function* () {
	...
	streamText(options) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			const writableStream = new WritableStream({
				...
				close() {
					return __awaiter$1(this, void 0, void 0, function* () {
						const trailer = new DataStream_Trailer({ streamId });
			...
			let onEngineClose = () => __awaiter$1(this, void 0, void 0, function* () {
				yield writer.close();
			});
...
var RemoteAudioTrack = class extends RemoteTrack {
	constructor(mediaTrack, sid, receiver, audioContext, audioOutput, loggerOptions) {
		...
		this.monitorReceiver = () => __awaiter$1(this, void 0, void 0, function* () {
			if (!this.receiver) {
				this._currentBitrate = 0;
				return;
			}
...
var RemoteVideoTrack = class extends RemoteTrack {
	...
	setStreamState(value) {
		...
		if (value === Track.StreamState.Active) this.updateVisibility();
	}
	/**
...
function createLocalTracks(options, loggerOptions) {
	return __awaiter$1(this, void 0, void 0, function* () {
		...
		if (internalOptions.audio === true || typeof internalOptions.audio === "object" && !internalOptions.audio.deviceId) internalOptions.audio = { deviceId: "default" };
		...
		try {
			...
			return yield Promise.all(stream.getTracks().map((mediaStreamTrack) => __awaiter$1(this, void 0, void 0, function* () {
...
function qualityFromProto(q) {
	switch (q) {
		case ConnectionQuality$1.EXCELLENT: return ConnectionQuality$2.Excellent;
		case ConnectionQuality$1.GOOD: return ConnectionQuality$2.Good;
		case ConnectionQuality$1.POOR: return ConnectionQuality$2.Poor;
		case ConnectionQuality$1.LOST: return ConnectionQuality$2.Lost;
		default: return ConnectionQuality$2.Unknown;
	}
}
...
var LocalParticipant = class extends Participant {
	...
	constructor(sid, identity, engine, options, roomRpcHandlers, roomOutgoingDataStreamManager) {
		...
		this.handleClosing = () => {
			...
			if (this.reconnectFuture) {
				...
				(_b = (_a = this.reconnectFuture) === null || _a === void 0 ? void 0 : _a.reject) === null || _b === void 0 || _b.call(_a, "Got disconnected during reconnection attempt");
				this.reconnectFuture = void 0;
			}
			if (this.signalConnectedFuture) {
				(_d = (_c = this.signalConnectedFuture).reject) === null || _d === void 0 || _d.call(_c, "Got disconnected without signal connected");
				this.signalConnectedFuture = void 0;
			}
			(_f = (_e = this.activeAgentFuture) === null || _e === void 0 ? void 0 : _e.reject) === null || _f === void 0 || _f.call(_e, "Got disconnected without active agent present");
		...
		this.handleSubscribedQualityUpdate = (update) => __awaiter$1(this, void 0, void 0, function* () {
			var _a, e_1, _b, _c;
			var _d;
		...
		this.handleTrackEnded = (track) => __awaiter$1(this, void 0, void 0, function* () {
	...
	*/
	...
	requestMetadataUpdate(_a) {
		return __awaiter$1(this, arguments, void 0, function(_ref) {
			var _this = this;
	...
	*/
	...
	publishOrRepublishTrack(track_1, options_1) {
		return __awaiter$1(this, arguments, void 0, function(track, options) {
			var _this2 = this;
			...
			return function* () {
				...
				const publishPromise = new Promise((resolve, reject) => __awaiter$1(_this2, void 0, void 0, function* () {
					try {
	...
	publish(track, opts, isStereo) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			const negotiate = () => __awaiter$1(this, void 0, void 0, function* () {
				var _a, _b, _c;
			...
			let ti;
			const addTrackPromise = new Promise((resolve, reject) => __awaiter$1(this, void 0, void 0, function* () {
				var _a;
				try {
			...
			if (isLocalAudioTrack(track) && ti.audioFeatures.includes(AudioTrackFeature.TF_PRECONNECT_BUFFER)) {
				...
				if (stream) new Promise((resolve, reject) => __awaiter$1(this, void 0, void 0, function* () {
					var _a, e_2, _b, _c;
					var _d, _e;
					try {
	...
	republishAllTracks(options_1) {
		return __awaiter$1(this, arguments, void 0, function(options) {
			...
			return function* () {
				...
				_this3.republishPromise = new Promise((resolve, reject) => __awaiter$1(_this3, void 0, void 0, function* () {
					try {
						const localPubs = [];
						...
						yield Promise.all(localPubs.map((pub) => __awaiter$1(this, void 0, void 0, function* () {
	...
	*/
	publishData(data_1) {
		return __awaiter$1(this, arguments, void 0, function(data) {
			var _this4 = this;
			let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
			return function* () {
	...
	*/
	performRpc(_a) {
		return __awaiter$1(this, arguments, void 0, function(_ref3) {
			var _this5 = this;
			let { destinationIdentity, method, payload, responseTimeout = 1e4 } = _ref3;
			return function* () {
				const maxRoundTripLatency = 2e3;
				return new Promise((resolve, reject) => __awaiter$1(_this5, void 0, void 0, function* () {
					var _a, _b, _c, _d;
	...
	*/
	...
	setActiveAgent(agent) {
		...
		else (_d = (_c = this.activeAgentFuture) === null || _c === void 0 ? void 0 : _c.reject) === null || _d === void 0 || _d.call(_c, "Agent disconnected");
		this.activeAgentFuture = void 0;
	}
...
var connectionReconcileFrequency = 4e3;
/**
...
var Room = class Room extends eventsExports.EventEmitter {
	...
	*/
	constructor(options) {
		...
		*/
		...
		this.connect = (url, token, opts) => __awaiter$1(this, void 0, void 0, function* () {
			var _a;
			...
			const connectFn = (resolve, reject, regionUrl) => __awaiter$1(this, void 0, void 0, function* () {
				var _a, _b;
				...
				try {
					...
					if (this.regionUrlProvider && e instanceof ConnectionError && e.reason !== ConnectionErrorReason.Cancelled && e.reason !== ConnectionErrorReason.NotAllowed) {
						...
						if (e instanceof ConnectionError) disconnectReason = getDisconnectReasonFromConnectionError(e);
		...
		this.connectSignal = (url, token, engine, connectOptions, roomOptions, abortController) => __awaiter$1(this, void 0, void 0, function* () {
			var _a, _b, _c;
		...
		this.applyJoinResponse = (joinResponse) => {
			...
			if (this.options.e2ee && this.e2eeManager) try {
		...
		this.attemptConnection = (url, token, opts, abortController) => __awaiter$1(this, void 0, void 0, function* () {
			var _a, _b;
		...
		*/
		this.disconnect = function() {
			...
			return __awaiter$1(_this, [...args_1], void 0, function() {
				var _this2 = this;
				...
				return function* () {
					...
					try {
						...
						if (_this2.state === ConnectionState.Connecting || _this2.state === ConnectionState.Reconnecting || _this2.isResuming) {
							...
							(_a = _this2.abortController) === null || _a === void 0 || _a.abort();
						...
						if (!((_d = _this2.engine) === null || _d === void 0 ? void 0 : _d.client.isDisconnected)) yield _this2.engine.client.sendLeave();
						if (_this2.engine) yield _this2.engine.close();
		...
		this.onPageLeave = () => __awaiter$1(this, void 0, void 0, function* () {
		...
		* - `getUserMedia`
		*/
		this.startAudio = () => __awaiter$1(this, void 0, void 0, function* () {
			const elements = [];
			const browser = getBrowser();
		...
		this.startVideo = () => __awaiter$1(this, void 0, void 0, function* () {
			const elements = [];
		...
		this.handleSignalRestarted = (joinResponse) => __awaiter$1(this, void 0, void 0, function* () {
		...
		this.handleDataPacket = (packet) => {
			...
			if (packet.value.case === "user") this.handleUserPacket(participant, packet.value.value, packet.kind);
			...
			else if (packet.value.case === "streamHeader" || packet.value.case === "streamChunk" || packet.value.case === "streamTrailer") this.handleDataStream(packet);
		...
		this.handleUserPacket = (participant, userPacket, kind) => {
			...
			participant === null || participant === void 0 || participant.emit(ParticipantEvent.DataReceived, userPacket.payload, kind);
		};
		...
		this.handleDeviceChange = () => __awaiter$1(this, void 0, void 0, function* () {
			var _a;
		...
		this.onLocalTrackPublished = (pub) => __awaiter$1(this, void 0, void 0, function* () {
			var _a, _b, _c, _d, _e, _f;
		...
		this.onLocalTrackRestarted = (track) => __awaiter$1(this, void 0, void 0, function* () {
		...
		if (this.options.e2ee) this.setupE2EE();
		if (isWeb()) {
			const abortController = new AbortController();
	...
	*/
	...
	setupE2EE() {
		...
		if (this.options.e2ee) {
			if ("e2eeManager" in this.options.e2ee) this.e2eeManager = this.options.e2ee.e2eeManager;
			else this.e2eeManager = new E2EEManager(this.options.e2ee);
	...
	*/
	simulateScenario(scenario, arg) {
		return __awaiter$1(this, void 0, void 0, function* () {
			let postAction = () => __awaiter$1(this, void 0, void 0, function* () {});
			let req;
			switch (scenario) {
				...
				case "disconnect-signal-on-resume":
					postAction = () => __awaiter$1(this, void 0, void 0, function* () {
						yield this.engine.client.handleOnClose("simulate resume-disconnect");
					});
					req = new SimulateScenario({ scenario: {
	...
	*/
	switchActiveDevice(kind_1, deviceId_1) {
		return __awaiter$1(this, arguments, void 0, function(kind, deviceId) {
			var _this3 = this;
...
eventsExports.EventEmitter;
//#endregion
//#region node_modules/webrtc-issue-detector/dist/bundle-esm.js
...
function l(t, e, s, n) {
	...
	if ((a = t._events) ? (a.newListener && (t.emit("newListener", e, s.listener ? s.listener : s), a = t._events), c = a[e]) : (a = t._events = new r(), t._eventsCount = 0), c) {
		if ("function" == typeof c ? c = a[e] = n ? [s, c] : [c, s] : n ? c.unshift(s) : c.push(s), !c.warned && (o = i(t)) && o > 0 && c.length > o) {
			c.warned = !0;
			var u = /* @__PURE__ */ new Error("Possible EventEmitter memory leak detected. " + c.length + " " + e + " listeners added. Use emitter.setMaxListeners() to increase limit");
...
r.prototype = Object.create(null), o.EventEmitter = o, o.usingDomains = !1, o.prototype.domain = void 0, o.prototype._events = void 0, o.prototype._maxListeners = void 0, o.defaultMaxListeners = 10, o.init = function() {
	this.domain = null, o.usingDomains && (void 0).active, this._events && this._events !== Object.getPrototypeOf(this)._events || (this._events = new r(), this._eventsCount = 0), this._maxListeners = this._maxListeners || void 0;
	...
	if (l = this.domain, p) {
		if (e = arguments[1], !l) {
			...
			var f = /* @__PURE__ */ new Error("Uncaught, unspecified \"error\" event. (" + e + ")");
			throw f.context = e, f;
		}
		return e || (e = /* @__PURE__ */ new Error("Uncaught, unspecified \"error\" event")), e.domainEmitter = this, e.domain = l, e.domainThrown = !1, l.emit("error", e), !1;
	}
	if (!(s = i[t])) return !1;
	...
	return s && (e = s[t]) ? "function" == typeof e ? [e.listener || e] : function(t) {
...
var k = class {
	...
	calculateOutboundScore(t) {
		const e = [...t.remote?.audio.inbound || [], ...t.remote?.video.inbound || []];
		if (!e.length) return;
		const s = this.#t[t.connection.id];
		if (!s) return;
		const n = [...s.remote?.audio.inbound || [], ...s.remote?.video.inbound || []], { packetsSent: r } = t.connection, o = s.connection.packetsSent, i = e.reduce(((t, e) => {
	...
	calculateInboundScore(t) {
		const e = [...t.audio?.inbound, ...t.video?.inbound];
		if (!e.length) return;
		const s = this.#t[t.connection.id];
		if (!s) return;
		const n = [...s.video?.inbound, ...s.audio?.inbound], { packetsReceived: r } = t.connection, o = s.connection.packetsReceived, i = e.reduce(((t, e) => {
			const s = n.find(((t) => t.ssrc === e.ssrc));
			return {
				sumJitter: t.sumJitter + e.jitter,
				packetsLost: t.packetsLost + e.packetsLost,
...
var y = class {
	...
	detect(t, e) {
		...
		return this.setLastProcessedStats(t.connection.id, s), this.performPrevStatsCleanup({ connectionId: t.connection.id }), n;
	}
...
var b = class extends y {
	...
	processData(t) {
		const n = [], r = [...t.audio?.inbound, ...t.video?.inbound];
		if (!r.length) return n;
		const o = this.getLastProcessedStats(t.connection.id);
		if (!o) return n;
		const i = [...o.video?.inbound, ...o.audio?.inbound], { packetsReceived: a } = t.connection, c = o.connection.packetsReceived, d = r.reduce(((t, e) => {
...
var P = class extends y {
	...
	processData(t) {
		...
		return o ? (n.forEach(((t) => {
			...
			if (i === a) return;
			const c = t.track.totalSamplesReceived - n.track.totalSamplesReceived, d = i - a, u = Math.round(100 * d / c), h = { correctedSamplesPct: u };
			u > this.#d && r.push({
				statsSample: h,
				type: e.Network,
				reason: s.NetworkMediaSyncFailure,
...
var T = class extends y {
	...
	processData(t) {
		const n = [], r = [...t.remote?.audio.inbound || [], ...t.remote?.video.inbound || []];
		if (!r.length) return n;
		const o = this.getLastProcessedStats(t.connection.id);
		if (!o) return n;
		const i = [...o.remote?.audio.inbound || [], ...o.remote?.video.inbound || []], { packetsSent: a } = t.connection, c = o.connection.packetsSent, d = r.reduce(((t, e) => {
...
var L = class extends y {
	...
	processData(t) {
		...
		return o ? (n.forEach(((t) => {
			const n = o.find(((e) => e.ssrc === t.ssrc));
			if (!n) return;
			const i = { qualityLimitationReason: t.qualityLimitationReason };
...
var D = class extends y {
	...
	processData(t) {
		...
		return t.video.inbound.forEach(((t) => {
			const { decoderImplementation: i, ssrc: a } = t;
			if (o?.find(((t) => t.ssrc === a))) if (i === this.UNKNOWN_DECODER) {
...
var C = (t) => t.reduce(((t, e) => t + e), 0) / t.length;
var R = (t, e, s = 30) => {
	const n = [];
...
var I = class extends y {
	...
	processData(t) {
		...
		const o = t.video.inbound.map(((e) => {
			...
			if (!s) return;
			if (M(e.ssrc, [r[r.length - 1], t])) return;
		...
		return o.length > 0 && (n.push({
			...
			statsSample: { ssrcs: o.map(((t) => t.ssrc)) }
...
var E = class extends y {
	...
	performDetection(t) {
		return [...this.getAllLastProcessedStats(t.connection.id), t].find(((t) => void 0 !== t.networkScores.inbound && t.networkScores.inbound <= this.#p)) ? [] : this.processData(t);
	}
	processData(t) {
		const n = [], r = [...this.getAllLastProcessedStats(t.connection.id), t], o = t.video.inbound.map(((t) => {
...
var N = (t) => "closed" === t.iceConnectionState || "closed" === t.connectionState;
var _ = (t, e, s) => 8 * ((t, e, s) => {
	if (!e) return 0;
	const n = t[s], r = e[s];
...
var A = class {
	...
	removePeerConnection(t) {
		...
		e >= 0 && this.removeConnectionsByIndexes([e]);
	}
	async parse() {
...
var O = class {
	...
	allowedReportTypes = /* @__PURE__ */ new Set([
		"candidate-pair",
		"inbound-rtp",
		"outbound-rtp",
		"remote-outbound-rtp",
	...
	async parse(t) {
		...
		this.logger.debug("Skip stats parsing. Connection is closed.", { connection: t });
	}
	async getConnectionStats(t) {
		...
		try {
			...
			return {
				id: s,
				stats: this.mapReportsStats([...i, ...a], t),
				timeTaken: Date.now() - n
			};
		} catch (t) {
			this.logger.error("Failed to get stats for PC", {
				id: s,
				pc: e,
				error: t
			});
	...
	updateMappedStatsWithReportItemData(t, e, s) {
		...
		if (!r) return;
		const o = t.ssrc;
		if (!o || !this.ignoreSSRCList.includes(o)) if ("outbound-rtp" !== n) if ("inbound-rtp" !== n) "remote-outbound-rtp" !== n ? "remote-inbound-rtp" === n && (this.mapConnectionStatsIfNecessary(e, t, s), e.remote[r].inbound.push({ ...t })) : e.remote[r].outbound.push({ ...t });
		else {
	...
	prepareConnectionStats(t, e) {
		if (!t || !e) return {};
		const s = { ...t };
		if (s.remoteCandidateId) s.remote = { ...e.get(s.remoteCandidateId) };
		if (s.localCandidateId) s.local = { ...e.get(s.localCandidateId) };
		return s;
	}
};
var J = class J extends y {
	#g = /* @__PURE__ */ new Map();
	#S;
	#v;
	constructor(t = {}) {
	...
	processData(t) {
		const n = [], r = [...this.getAllLastProcessedStats(t.connection.id), t];
	...
	detectMissingData(t, e, s) {
		...
		return r.forEach(((t) => {
			...
			const a = { bytesReceived: t.bytesReceived };
			n.push({
				type: e,
				reason: s,
				statsSample: a,
	...
	static isAllBytesReceivedDidntChange(t, e) {
		for (let s = 0; s < e.length; s += 1) if (e[s].bytesReceived !== t) return !1;
		return !0;
	}
	markIssue(t) {
...
var x = class {
	...
	constructor(e) {
		this.logger = e.logger ?? {
			...
			new E(),
			new J()
		], this.networkScoresCalculator = e.networkScoresCalculator ?? new k(), this.compositeStatsParser = e.compositeStatsParser ?? new A({ statsParser: new O({
			...
			this.detectIssues({ data: t.stats }, e);
	...
	detectIssues({ data: t }, e) {
		const s = this.detectors.reduce(((s, n) => [...s, ...n.detect(t, e)]), []);
...
//#endregion
//#region node_modules/@heygen/liveavatar-web-sdk/lib/index.esm.js
/******************************************************************************
Copyright (c) Microsoft Corporation.
...
var getAgentEventEmitArgs = (event) => {
	if ("event_type" in event) switch (event.event_type) {
...
(function(CommandEventsEnum) {
	...
	CommandEventsEnum["ELEVENLABS_AGENT_COMMAND"] = "elevenlabs_agent_command";
})(CommandEventsEnum || (CommandEventsEnum = {}));
var ElevenLabsAgentCommandType;
(function(ElevenLabsAgentCommandType) {
	ElevenLabsAgentCommandType["USER_MESSAGE"] = "user_message";
	ElevenLabsAgentCommandType["CONTEXTUAL_UPDATE"] = "contextual_update";
	ElevenLabsAgentCommandType["USER_ACTIVITY"] = "user_activity";
	ElevenLabsAgentCommandType["CLIENT_TOOL_RESULT"] = "client_tool_result";
})(ElevenLabsAgentCommandType || (ElevenLabsAgentCommandType = {}));
var SessionMode;
...
(function(AgentType) {
	AgentType["FULL"] = "FULL";
	AgentType["OPENAI_REALTIME"] = "OPENAI_REALTIME";
	AgentType["ELEVENLABS_AGENT"] = "ELEVENLABS_AGENT";
	AgentType["GEMINI_REALTIME"] = "GEMINI_REALTIME";
...
var AbstractConnectionQualityIndicator = class {
	...
	stop(muted = false) {
		this._stop();
		this._connectionQuality = ConnectionQuality.UNKNOWN;
		if (!muted) this.onConnectionQualityChanged(ConnectionQuality.UNKNOWN);
	}
};
function QualityIndicatorComposite(...configs) {
	class CombinedQualityIndicator extends AbstractConnectionQualityIndicator {
		...
		calculateConnectionQuality() {
			...
			if (connectionQualities.some((quality) => quality === ConnectionQuality.BAD)) return ConnectionQuality.BAD;
			if (connectionQualities.every((quality) => quality === ConnectionQuality.UNKNOWN)) return ConnectionQuality.UNKNOWN;
...
var LiveKitConnectionQualityIndicator = class extends AbstractConnectionQualityIndicator {
	constructor() {
		super(...arguments);
		this.room = null;
	...
	calculateConnectionQuality() {
		if ([ConnectionQuality$2.Lost, ConnectionQuality$2.Poor].includes(this.liveKitConnectionQuality)) return ConnectionQuality.BAD;
		if (this.liveKitConnectionState && [
			ConnectionState.Disconnected,
			ConnectionState.Reconnecting,
			ConnectionState.SignalReconnecting
		].includes(this.liveKitConnectionState)) return ConnectionQuality.BAD;
		return ConnectionQuality.GOOD;
	}
};
var WebRTCConnectionQualityIndicator = class extends AbstractConnectionQualityIndicator {
	constructor() {
		super(...arguments);
	...
	calculateConnectionQuality() {
		if (!this.mosScores || !this.mosScores.inbound && !this.mosScores.outbound) return ConnectionQuality.UNKNOWN;
		if (this.mosScores.inbound && this.mosScores.inbound < 3 || this.mosScores.outbound && this.mosScores.outbound < 3) return ConnectionQuality.BAD;
		return ConnectionQuality.GOOD;
	}
};
var ConnectionQualityIndicator = QualityIndicatorComposite({
...
var LIVEKIT_COMMAND_CHANNEL_TOPIC = "agent-control";
var LIVEKIT_SERVER_RESPONSE_CHANNEL_TOPIC = "agent-response";
var API_URL = "https://api.liveavatar.com";
var initEventPromise = (room, eventType, rejectionEventType) => {
	return new Promise((resolve, reject) => {
		const messageHandler = (roomMessage, _, __, topic) => {
			...
			if (eventData && "event_type" in eventData) {
				...
				if (type === eventType || type === rejectionEventType) {
					...
					if (type === rejectionEventType) reject();
					else resolve();
				}
			}
		};
...
var VoiceChat = class extends import_events.EventEmitter {
	constructor(room) {
		super();
	...
	get isConnected() {
		return this.room.state !== ConnectionState.Disconnected && this.room.state !== ConnectionState.Connecting;
	}
	setMode(mode) {
		if (this.mode) {
	...
	start() {
		return __awaiter(this, arguments, void 0, function* (config = {}) {
			...
			} else this.emit(VoiceChatEvent.UNMUTED);
	...
	stop() {
		this.room.localParticipant.getTrackPublications().forEach((publication) => {
			if (publication.track && publication.track.kind === Track.Kind.Audio) publication.track.stop();
		});
		if (this.track) {
	...
	mute() {
		return __awaiter(this, void 0, void 0, function* () {
			if (!this.assertActive("Voice chat can only be muted when active")) return;
			if (this.track) yield this.track.mute();
		});
	}
	unmute() {
		return __awaiter(this, void 0, void 0, function* () {
			if (!this.assertActive("Voice chat can only be unmuted when active")) return;
			if (this.track) yield this.track.unmute();
		});
	}
	setDevice(deviceId) {
		return __awaiter(this, void 0, void 0, function* () {
			if (!this.assertActive("Voice chat device can only be set when active")) return false;
			if (this.track) return this.track.setDeviceId(deviceId);
			return false;
		});
	}
	startPushToTalk() {
		return __awaiter(this, void 0, void 0, function* () {
			if (!this.assertActive("Push to talk can only be started when voice chat is active")) return;
...
var SessionAPIClient = class {
	...
	request(path, params) {
		return __awaiter(this, void 0, void 0, function* () {
			try {
				const response = yield fetch(`${this.apiUrl}${path}`, Object.assign(Object.assign({}, params), {
					credentials: "include",
				...
				const data = yield response.json();
				if (data.code !== SUCCESS_CODE) throw new SessionApiError(data.message || "API request failed");
				return data.data;
			} catch (err) {
...
function splitPcm24kStringToChunks(pcmString) {
	const firstChunkBytes = 19200;
	const subsequentChunkBytes = 48e3;
	const totalLength = pcmString.length;
	const result = [];
	if (totalLength === 0) return result;
	result.push(pcmString.slice(0, firstChunkBytes));
	for (let i = firstChunkBytes; i < totalLength; i += subsequentChunkBytes) result.push(pcmString.slice(i, i + subsequentChunkBytes));
	return result;
}
var HEYGEN_PARTICIPANT_ID = "heygen";
var LIVEAVATAR_AGENT_PARTICIPANT_ID_PREFIX = "liveavatar-agent-";
var REQUIRED_PARTICIPANTS_TIMEOUT_MS = 3e4;
function decodeSessionTokenPayload(token) {
	try {
		const parts = token.split(".");
		if (parts.length < 2) {
			console.warn("[decodeSessionTokenPayload] Token does not look like a JWT (parts.length =", parts.length, "). Raw token (first 40 chars):", token.slice(0, 40));
			return null;
		}
		const payload = parts[1];
		return JSON.parse(atob(payload.replace(/-/g, "+").replace(/_/g, "/")));
	} catch (e) {
		console.warn("[decodeSessionTokenPayload] Failed to decode session token payload. Raw token (first 40 chars):", token.slice(0, 40), "Error:", e);
		return null;
	}
}
...
function parseAgentTypeFromToken(token) {
	const decoded = decodeSessionTokenPayload(token);
	...
	if (typeof data.agent_type === "string") {
		...
		if (explicit in AgentType) return explicit;
	}
...
var LiveAvatarSession = class extends import_events.EventEmitter {
	constructor(sessionAccessToken, config) {
		...
		if (this.config.voiceChat && typeof this.config.voiceChat === "object" && this.config.voiceChat.mode) this._voiceChat.setMode(this.config.voiceChat.mode);
	}
	get state() {
		return this._state;
	}
	...
	message(message) {
		if (!this.assertConnected()) throw new Error("Session needs to be connected to send command event");
	...
	interrupt() {
		if (!this.assertConnected()) throw new Error("Session needs to be connected to send command event");
		const data = { event_type: CommandEventsEnum.AVATAR_INTERRUPT };
		this.sendCommandEvent(data);
	}
	trackEvents() {
		...
		this.room.on(RoomEvent.TrackSubscribed, (track, _publication, participant) => {
			...
			if (track.kind === "video" || track.kind === "audio") {
				if (track.kind === "video") this._remoteVideoTrack = track;
				else this._remoteAudioTrack = track;
				mediaStream.addTrack(track.mediaStreamTrack);
				const hasVideoTrack = mediaStream.getVideoTracks().length > 0;
				const hasAudioTrack = mediaStream.getAudioTracks().length > 0;
				if (hasVideoTrack && hasAudioTrack) this.emit(SessionEvent.SESSION_STREAM_READY);
			}
		});
	...
	waitForRequiredParticipants() {
		var _a;
		if (this._mode !== SessionMode.FULL) return Promise.resolve();
		...
		const required = /* @__PURE__ */ new Set([HEYGEN_PARTICIPANT_ID, agentId]);
		for (const p of this.room.remoteParticipants.values()) required.delete(p.identity);
		if (required.size === 0) return Promise.resolve();
		return new Promise((resolve, reject) => {
			...
			const timeout = setTimeout(() => {
				cleanup();
				reject(/* @__PURE__ */ new Error(`Timed out waiting for required participants: ${Array.from(required).join(", ")}`));
	...
	handleWebSocketMessage(event) {
		...
		if (type === "agent.speak_started") this.emit(AgentEventsEnum.AVATAR_SPEAK_STARTED, {
			event_type: AgentEventsEnum.AVATAR_SPEAK_STARTED,
			event_id
		});
		else if (type === "agent.speak_ended") this.emit(AgentEventsEnum.AVATAR_SPEAK_ENDED, {
			event_type: AgentEventsEnum.AVATAR_SPEAK_ENDED,
			event_id
		});
	}
	handleWebSocketDisconnect() {
		if (this.state === SessionState.DISCONNECTING || this.state === SessionState.DISCONNECTED) return;
		if (this._sessionEventSocket && this._sessionEventSocket.readyState === WebSocket.OPEN) this._sessionEventSocket.close();
		this._sessionEventSocket = null;
		this.cleanup();
	...
	cleanup() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			this.voiceChat.stop();
			if (this._remoteAudioTrack) this._remoteAudioTrack.stop();
			if (this._remoteVideoTrack) this._remoteVideoTrack.stop();
			this._remoteAudioTrack = null;
			this._remoteVideoTrack = null;
			...
			if (this._sessionEventSocket) {
				...
				if (this._sessionEventSocket.readyState === WebSocket.OPEN || this._sessionEventSocket.readyState === WebSocket.CONNECTING) this._sessionEventSocket.close();
				this._sessionEventSocket = null;
			}
	...
	sendCommandEvent(commandEvent) {
		if (this._sessionEventSocket && this._sessionEventSocket.readyState === WebSocket.OPEN) this.sendCommandEventToWebSocket(commandEvent);
		else if (this.room.state === "connected") this.publishAgentControl(commandEvent);
		else console.warn("No active connection to send command event");
	}
	publishAgentControl(payload) {
		if (this.room.state !== "connected") throw new Error("LiveKit room not connected — cannot publish agent-control payload");
	...
	sendCommandEventToWebSocket(commandEvent) {
		if (!this._sessionEventSocket || this._sessionEventSocket.readyState !== WebSocket.OPEN) {
		...
		switch (event_type) {
			case CommandEventsEnum.AVATAR_SPEAK_AUDIO:
				...
				for (const audioChunk of audioChunks) this._sessionEventSocket.send(JSON.stringify({
					type: "agent.speak",
					event_id,
					audio: audioChunk
				}));
			...
			case CommandEventsEnum.AVATAR_SPEAK_RESPONSE: throw new Error("Not permitted in LITE mode");
			...
			case CommandEventsEnum.AVATAR_STOP_LISTENING:
				...
				return;
			default: console.warn("Unsupported command event type:", event_type);
		}
	}
	assertConnected() {
...
var ElevenLabsAgentSessionError = class extends Error {
	constructor(message) {
		super(message);
...
*/
var ElevenLabsAgentSession = class extends LiveAvatarSession {
	constructor(sessionAccessToken, config) {
	...
	*/
	sendElevenLabsAgentCommand(payload, options) {
		var _a;
		if (!this.assertConnected()) throw new ElevenLabsAgentSessionError("Session must be connected before sending ElevenLabs agent commands");
		const sessionId = this.sessionId;
		if (!sessionId) throw new ElevenLabsAgentSessionError("Session id is not yet available — wait for session.started");
		const event_id = this.generateEventId();
		const wrapper = Object.assign({
			event_type: CommandEventsEnum.ELEVENLABS_AGENT_COMMAND,
			event_id,
			session_id: sessionId,
			source_event_id: (_a = options === null || options === void 0 ? void 0 : options.sourceEventId) !== null && _a !== void 0 ? _a : null
		}, payload);
	...
	sendUserActivity() {
		return this.sendElevenLabsAgentCommand({ elevenlabs_event_type: ElevenLabsAgentCommandType.USER_ACTIVITY });
	}
	/** Reply to a client_tool_call inbound event with the tool result. */
	sendClientToolResult(args) {
		var _a;
		return this.sendElevenLabsAgentCommand({
			...
			data: {
				...
				result: args.result,
				is_error: (_a = args.isError) !== null && _a !== void 0 ? _a : false
			}
		}, { sourceEventId: args.sourceEventId });
	}
	message(_message) {
		throw new ElevenLabsAgentSessionError("message() is not supported on ElevenLabsAgentSession — use sendUserMessage()");
	}
	repeat(_message) {
		throw new ElevenLabsAgentSessionError("repeat() is not supported on ElevenLabsAgentSession — the ElevenLabs agent owns response generation");
	}
	repeatAudio(_audio) {
		throw new ElevenLabsAgentSessionError("repeatAudio() is not supported on ElevenLabsAgentSession");
	}
};
//#endregion
export { AgentEventsEnum, AgentType, CommandEventsEnum, ConnectionQuality, ElevenLabsAgentCommandType, ElevenLabsAgentSession, ElevenLabsAgentSessionError, Language, LiveAvatarSession, SessionDisconnectReason, SessionEvent, SessionInteractivityMode, SessionMode, SessionState, VoiceChatEvent, VoiceChatState, parseAgentTypeFromToken };
